...
class Mailer {
    protected $_ci;
    protected $email_pengirim = 'avi.sanja@gmail.com'; // Isikan dengan email pengirim
    protected $nama_pengirim = 'Sanja Avi'; // Isikan dengan nama pengirim
    protected $password = 'anonymous911'; // Isikan dengan password email pengirim
